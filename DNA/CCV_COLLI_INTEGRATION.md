...
- nel menu pubblico Colli, i prezzi devono essere in grassetto e i prodotti vegetariani devono mostrare l'icona standard `IoLeafSharp` di `react-icons/io5` sempre prima del nome (`foglia + spazio + testo`), mai a fine testo;
