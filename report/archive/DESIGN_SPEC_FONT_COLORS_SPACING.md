...
```html
<h2 class="font-display text-3xl md:text-4xl text-foreground">Bollicine Italiane</h2>
```
...
```html
<h3 class="font-sans font-bold text-base uppercase tracking-wide">PIGNOLETTO BRUT BIO</h3>
```
...
```html
<p class="font-sans text-sm text-muted-foreground">Montevecchio Isolani · BOLOGNA</p>
```
...
```html
<button
  class="font-sans px-4 py-2 rounded-md bg-accent text-secondary-foreground hover:bg-accent/80"
>
  English
</button>
```
