...
const imagesToUpload: ImageToUpload[] = [
  {
    filePath: "./LOGOS/logo_ccv.png",
    categorySlug: "logo",
    altIt: "Logo Camera con Vista",
    altEn: "Camera con Vista Logo",
  },
  {
    filePath: "./LOGOS/Logo_ccv_2_optimized_1770126702818.png",
    categorySlug: "logo",
    altIt: "Logo Camera con Vista Ottimizzato",
    altEn: "Camera con Vista Logo Optimized",
  },
  {
    filePath: "./LOGOS/icona_ccv.png",
    categorySlug: "logo",
    altIt: "Icona Camera con Vista",
    altEn: "Camera con Vista Icon",
  },
  {
  ...
  {
    filePath: "./attached_assets/logo_ccv.png",
    categorySlug: "logo",
    altIt: "Logo CCV Assets",
    altEn: "CCV Logo Assets",
  },
];
