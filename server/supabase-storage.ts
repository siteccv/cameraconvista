...
export class SupabaseStorage implements IStorage {
  ...
  private enrichBlockWithSnapshot(block: any): any {
    ...
    if (
      ...
      (camelBlock.metadata as any).__publishedSnapshot
    ) {
