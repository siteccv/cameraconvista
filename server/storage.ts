...
export interface IStorage {
  ...
  updateMediaCategory(
    id: number,
    category: Partial<InsertMediaCategory>,
...
export class DatabaseStorage implements IStorage {
  ...
  async updatePageBlock(
    id: number,
    block: Partial<InsertPageBlock>,
  ): Promise<PageBlock | undefined> {
    const result = await db
      .update(pageBlocks)
  ...
  async updateCocktail(
    id: number,
    cocktail: Partial<InsertCocktail>,
  ): Promise<Cocktail | undefined> {
    const result = await db
      .update(cocktails)
      .set({ ...cocktail, updatedAt: new Date() })
  ...
  async seedInitialData(): Promise<void> {
    ...
    const seedMenuItems: InsertMenuItem[] = [
      {
        category: "Antipasti",
        nameIt: "Tartare di Manzo",
        nameEn: "Beef Tartare",
        descriptionIt: "Con tuorlo d'uovo, capperi e senape",
        descriptionEn: "With egg yolk, capers and mustard",
        price: "18",
        sortOrder: 1,
      },
      {
        ...
        nameEn: "Apulian Burrata",
        descriptionIt: "Con pomodorini e basilico fresco",
        descriptionEn: "With cherry tomatoes and fresh basil",
        price: "16",
        sortOrder: 2,
      },
      {
        ...
        nameEn: "Tagliatelle with Ragù",
        descriptionIt: "Pasta fresca con ragù bolognese tradizionale",
        descriptionEn: "Fresh pasta with traditional Bolognese ragù",
        price: "16",
        sortOrder: 3,
      },
      {
        ...
        nameEn: "Tortellini in Broth",
        descriptionIt: "Tortellini fatti a mano in brodo di cappone",
        descriptionEn: "Handmade tortellini in capon broth",
        price: "18",
        sortOrder: 4,
      },
      {
        ...
        nameEn: "Beef Fillet",
        descriptionIt: "Con riduzione al Sangiovese",
        descriptionEn: "With Sangiovese reduction",
        price: "32",
        sortOrder: 5,
      },
      {
        ...
        descriptionIt: "Con patate e olive taggiasche",
        descriptionEn: "With potatoes and Taggiasca olives",
        price: "28",
        sortOrder: 6,
      },
      {
        ...
        nameIt: "Tiramisù",
        nameEn: "Tiramisù",
        descriptionIt: "Ricetta tradizionale della casa",
        descriptionEn: "Traditional house recipe",
        price: "10",
        sortOrder: 7,
      },
      {
        ...
        nameIt: "Panna Cotta",
        nameEn: "Panna Cotta",
        descriptionIt: "Con coulis di frutti di bosco",
        descriptionEn: "With berry coulis",
        price: "9",
        sortOrder: 8,
      },
    ];
    ...
    const seedWines: InsertWine[] = [
      {
        category: "Bollicine",
        nameIt: "Franciacorta Brut",
        nameEn: "Franciacorta Brut",
        region: "Lombardia",
        year: "NV",
        price: "45",
        sortOrder: 1,
      ...
      {
        category: "Bollicine",
        nameIt: "Champagne Veuve Clicquot",
        nameEn: "Champagne Veuve Clicquot",
        region: "Champagne",
        year: "NV",
        price: "85",
        sortOrder: 2,
      ...
      {
        category: "Bianchi",
        nameIt: "Pignoletto Classico",
        nameEn: "Pignoletto Classico",
      ...
      {
        category: "Bianchi",
        nameIt: "Verdicchio dei Castelli di Jesi",
        nameEn: "Verdicchio dei Castelli di Jesi",
        region: "Marche",
        year: "2021",
        price: "32",
        sortOrder: 4,
      ...
      {
        category: "Rossi",
        nameIt: "Sangiovese di Romagna Superiore",
        nameEn: "Sangiovese di Romagna Superiore",
        region: "Emilia-Romagna",
        year: "2020",
        price: "30",
        sortOrder: 5,
    ...
    const seedCocktails: InsertCocktail[] = [
      {
        ...
        nameIt: "Vista Sunset",
        nameEn: "Vista Sunset",
        descriptionIt: "Aperol, prosecco, succo d'arancia, soda",
        descriptionEn: "Aperol, prosecco, orange juice, soda",
        price: "12",
        sortOrder: 1,
      },
      {
        category: "Signature",
        nameIt: "Bologna Negroni",
        nameEn: "Bologna Negroni",
        descriptionIt: "Gin, Campari, Vermouth rosso, scorza d'arancia",
        descriptionEn: "Gin, Campari, red Vermouth, orange peel",
        price: "14",
        sortOrder: 2,
      },
      {
        ...
        nameIt: "Martini Dry",
        nameEn: "Dry Martini",
        descriptionIt: "Gin, Vermouth dry, oliva",
        descriptionEn: "Gin, dry Vermouth, olive",
        price: "12",
        sortOrder: 3,
      },
      {
        category: "Classici",
        nameIt: "Old Fashioned",
        nameEn: "Old Fashioned",
        descriptionIt: "Bourbon, zucchero, Angostura, scorza d'arancia",
        descriptionEn: "Bourbon, sugar, Angostura, orange peel",
        price: "13",
        sortOrder: 4,
      },
      {
        ...
        nameIt: "Mojito",
        nameEn: "Mojito",
        descriptionIt: "Rum bianco, lime, menta, zucchero, soda",
        descriptionEn: "White rum, lime, mint, sugar, soda",
        price: "11",
        sortOrder: 5,
      },
      {
        ...
        descriptionIt: "Lime, menta, zucchero, soda",
        descriptionEn: "Lime, mint, sugar, soda",
        price: "8",
        sortOrder: 6,
      },
    ];
    ...
    const seedEvents: InsertEvent[] = [
      {
        titleIt: "Jazz Night",
        titleEn: "Jazz Night",
        descriptionIt: "Serata di musica jazz dal vivo con aperitivo",
        descriptionEn: "Live jazz music evening with aperitif",
        startAt: new Date("2026-02-14T19:00:00"),
        active: true,
        sortOrder: 1,
      },
      {
        titleIt: "Degustazione Vini Emiliani",
        titleEn: "Emilian Wine Tasting",
        descriptionIt: "Scopri i migliori vini della nostra regione",
        descriptionEn: "Discover the best wines of our region",
        startAt: new Date("2026-02-21T18:00:00"),
        active: true,
        sortOrder: 2,
      },
    ];
