      ...
      <section className="py-8 md:py-12">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="bg-card rounded-xl p-6 md:p-8" data-testid="section-cena">
            <EditableText
              textIt={sectionABlock?.titleIt || sectionADef.titleIt || ""}
              textEn={sectionABlock?.titleEn || sectionADef.titleEn || ""}
              fontSizeDesktop={sectionABlock?.titleFontSize || sectionADef.titleFontSize || 24}
              fontSizeMobile={sectionABlock?.titleFontSizeMobile || sectionADef.titleFontSizeMobile || 20}
              as="h3"
              className="font-display mb-4"
              applyFontSize
              onSave={makeTextSave(sectionABlock, "title")}
            />
            <EditableText
              textIt={sectionABlock?.bodyIt || sectionADef.bodyIt || ""}
              textEn={sectionABlock?.bodyEn || sectionADef.bodyEn || ""}
              fontSizeDesktop={sectionABlock?.bodyFontSize || sectionADef.bodyFontSize || 16}
              fontSizeMobile={sectionABlock?.bodyFontSizeMobile || sectionADef.bodyFontSizeMobile || 14}
              as="p"
              className="text-muted-foreground whitespace-pre-line"
              multiline
              applyFontSize
              onSave={makeTextSave(sectionABlock, "body")}
            />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={idx} data-testid={`cena-gallery-${idx}`}>
                <ImageContainer
