...
export const TEASER_BLOCK_DEFAULTS: TeaserBlockDefault[] = [
  {
    ...
    titleEn: "Our Menu",
    bodyIt:
      "La nostra cucina celebra i sapori autentici della tradizione italiana, reinterpretati con creatività e ingredienti di stagione. Ogni piatto è un viaggio sensoriale tra gusto e raffinatezza.",
    bodyEn:
      "Our cuisine celebrates the authentic flavors of Italian tradition, reinterpreted with creativity and seasonal ingredients. Each dish is a sensory journey between taste and refinement.",
  ...
  },
  {
    ...
    titleEn: "Our Wines",
    bodyIt:
      "Una selezione curata di etichette italiane e internazionali, scelte per accompagnare ogni momento della vostra esperienza. Dal calice alla bottiglia, ogni vino racconta il suo territorio.",
    bodyEn:
      "A curated selection of Italian and international labels, chosen to accompany every moment of your experience. From the glass to the bottle, each wine tells the story of its territory.",
  ...
  },
  {
    ...
    bodyIt:
      "Cocktail creativi preparati con ingredienti di prima qualità dai nostri mixologist. Ogni creazione è pensata per sorprendere e deliziare, rispettando la tradizione mentre esplora nuovi orizzonti del gusto.",
    bodyEn:
      "Creative cocktails crafted with premium ingredients by our mixologists. Each creation is designed to surprise and delight, respecting tradition while exploring new horizons of taste.",
  ...
  },
  {
    ...
    titleEn: "Our Events",
    bodyIt:
      "Serate a tema, degustazioni, musica dal vivo e molto altro. Scopri il calendario degli eventi e vivi esperienze indimenticabili in un'atmosfera unica.",
    bodyEn:
      "Themed nights, tastings, live music and much more. Discover our events calendar and enjoy unforgettable experiences in a unique atmosphere.",
